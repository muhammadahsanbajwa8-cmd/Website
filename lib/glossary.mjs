...
const ENTRIES = [
  ...
  {
    names: ['christmas', 'christmas day'],
    text: `25 December, the Christian feast of the birth of Jesus, and in much of the world a secular family holiday as well. It is the most widely observed public holiday on the calendar, and in many countries the surrounding days are taken off with it.`,
  },
  {
    // The trailing space this list once carried on 'christmas day ' normalised
    // away, and the Julian entry answered for 25 December everywhere.
    names: ['orthodox christmas', 'orthodox christmas day'],
