...
function holidayTable(holidays, caption) {
  const rows = holidays
    .map((holiday) => {
      ...
      <td>${esc(holiday.name)}${
        ...
        holiday.estimated
          ? '<br><span class="note mono" title="Set by the lunar calendar; the observed date can move by a day">estimated date</span>'
          : ''
      }</td>
...
<section class="section">
  <div class="wrap">
    ...
    ${holidayTable(holidays, `${country.name} public holidays ${year}`)}
  </div>
</section>
...
<section class="section">
  <div class="wrap prose">
    ...
    <p class="note">Source: ${
      origin === 'computed'
        ? 'dates computed from statutory rules (see <a href="/about/">method</a>)'
        : 'Nager.Date public API, cached at build time'
    }. Regional and local holidays may be incomplete — see the <a href="/about/">limits of the data</a>.</p>
    ${
...
<section class="section">
  <div class="wrap prose">
    ...
    <p>Looking for the full list? See the
      <a href="${url.country(country.code)}">${esc(country.name)} holiday calendars</a>.</p>
  </div>
</section>
